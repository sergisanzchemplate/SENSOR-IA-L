...
# Crear el modelo base a partir de MobileNetV2
...
plt.legend()
plt.savefig('accuracy_loss_MobileNetV2.png')




# Guardar el modelo en formato TF
model.save('model_saved_MobileNetV2.keras')

# Cargar el modelo guardado
saved_model = tf.keras.models.load_model('model_saved_MobileNetV2.keras')
