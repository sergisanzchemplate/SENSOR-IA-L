...
# Crear el modelo base a partir de InceptionV3
...
plt.legend()
plt.savefig('accuracy_loss_InceptionV3.png')




# Guardar el modelo en formato keras
model.save('model_saved_InceptionV3.keras')

# Cargar el modelo guardado
saved_model = tf.keras.models.load_model('model_saved_InceptionV3.keras')
