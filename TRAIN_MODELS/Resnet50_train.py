...
# Crear el modelo base a partir de ResNet50
...
plt.legend()
plt.savefig('accuracy_loss_ResNet50.png')




# Guardar el modelo en formato keras
model.save('model_saved_ResNet50.keras')

# Cargar el modelo guardado
saved_model = tf.keras.models.load_model('model_saved_ResNet50.keras')
