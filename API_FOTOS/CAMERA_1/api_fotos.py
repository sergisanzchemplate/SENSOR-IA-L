...
def capture_images():
    ...
    folder_name = os.path.join(os.path.dirname(__file__), "static", "imagenes_cam1", "dia_" + current_date)
...
def sync_with_server():
    ...
    local_folder = '/home/camera/Desktop/API_FOTOS/static/imagenes_cam1'

    # Parámetros de la sincronización
    remote_folder = '/mnt/nvme/chemplate/static/imagenes_cam1'
...
DATA_FOLDER = "/home/camera/Desktop/API_FOTOS/tensorFlowLite/"
...
def gen_frames():
    ...
    # Rutas de los archivos y otras configuraciones
    DATA_FOLDER = "/home/camera/Desktop/API_FOTOS/tensorFlowLite/"
    model_path = DATA_FOLDER + "model1_cubeta2.tflite"
...
def save_to_database(timestamp, estacio, estat, confidence, image_base64):
    try:
        ...
        cur.execute("""
            INSERT INTO images_cubeta2 (timestamp, estacio, estat, confidence, imatge)
            VALUES (%s, %s, %s, %s, %s)
...
if __name__ == '__main__':
    app.run(debug=True, host='192.168.50.113')
